...
public class pens {
    public static int equaldivision(int number, int students){
        int divide= number/students;
        return divide;
    ...
    public static void main(String args[]){
        int number = 14;
        int students = 3;
        int divide = equaldivision(number, students);
        int remaining = number % students;
